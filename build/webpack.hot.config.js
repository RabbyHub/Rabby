...
// UI 入口配置 - 启用 HMR 和 codeInspectorPlugin
const uiConfig = {
  ...commonConfig,
  name: 'ui',
  entry: isHot
    ? {
        ui: [
          'webpack-hot-middleware/client?path=http://localhost:3173/__webpack_hmr&timeout=20000&reload=true',
          paths.rootResolve('src/ui/index.tsx'),
        ],
      }
    : {
...
// 其他入口配置 - 不启用 HMR 和 codeInspectorPlugin
const otherConfig = {
  ...commonConfig,
  name: 'other',
  entry: {
        ...
        oneOf: [
          ...
          },
          {
            ...
            options: {
              ...(useForkTsChecker ? { transpileOnly: true } : {}),
              getCustomTransformers: () => ({
                before: [tsStyledComponentTransformer].filter(Boolean),
              }),
            },
          },
        ],
...
module.exports = [uiConfig, otherConfig];
