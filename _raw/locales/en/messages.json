{
  "page": {
    ...
    "sendPoly": {
      ...
      "enterAddressOrENS": "Enter or Search address",
      "selectExchangeSource": "Select Exchange Source",
      "emptyWhitelist": {
        "title": "Add Whitelist Address",
        "desc": "Add trusted addresses to whitelist for fast transfers - no confirmation needed next time",
        "addNow": "Add Now"
      },
      "whitelist": {
        "title": "Whitelist",
        "addWhitelistDesc": "Add trusted addresses to whitelist for fast transfers---no confirmation needed next time",
        "addWhitelist": "Add to whitelist",
        "removeFromWhitelist": "Remove from whitelist",
        "notWhitelist": "Not a whitelist Address"
      },
      "sendToImportedAddress": "Send to Imported Address",
      "selectImportedAddress": "Select Imported address",
      "addWhitelist": {
        "title": "Add Whitelist Address",
        "desc": "Add trusted addresses to whitelist for fast transfers---no confirmation needed next time"
      },
      "riskAlert": {
        ...
        "understandRisks": "I understand the risks and want to continue",
        "cexDepositAddress": "{{cexName}} Deposit Address",
        "cexAddress": "{{cexName}} Address",
        "passwordPlaceholder": "Input password to continue",
        "TransferBefore": "Transferred before",
        "TransferBeforeValue": "Yes",
        "AddToWhitelist": "Add to Whitelist",
        "riskType": {
          "risks": {
            "noSend": "No transfers to this address in 180 days",
            "dexNoDeposite": "Not a CEX deposit address, funds may be lost",
            "contractAddress": "Contract address detected, funds may be lost",
            "scamAddress": "Scam address flagged by Rabby"
          }
        }
      }
    },
    "whitelist": {
      ...
      "nameYourAddress": "Name Your Address",
      "addSuccess": "Add successfully",
      "invalidAddress": "This address is invalid",
      "enterAddress": "Enter address",
      "riskTitle": "Add address to whitelist",
      "confirmPassword": "Confirm Password",
      "tips": {
        "removed": "Whitelist address deleted",
        "added": "Address added to whitelist",
        "repeated": "The current address is already on the whitelist.",
        "tooltip": "Whitelist address"
      }
    },
    "sendTokenComponents": {
      "GasReserved": "Reserved <1>0</1> {{ tokenName }} for gas cost",
      "SwitchReserveGas": "Reserve Gas <1 />"
    },
    "sendNFT": {
      "header": {
        "title": "Send"
    ...
    "approvals": {
      ...
      "component": {
        "table": {
          "bodyEmpty": {
            "7702": "No EIP-7702 Delegation",
            "loadingText": "Loading...",
            "noDataText": "No Approvals",
            "noMatchText": "No Match"
          }
        },
        "EIP7702SupportChains": "EIP-7702 Supported Chains:",
        ...
        "RevokeButton": {
          ...
          "permit2Batch": {
            "modalContent": "Approvals from the same Permit2 contract would be packaged together under the same signature.",
            "modalTitle_one": "A total of <2>{{count}}</2> signature is required",
            "modalTitle_other": "A total of <2>{{count}}</2> signatures is required"
          },
          "notSupport7702Title": "Not Supported for Current Address Type",
          "notSupport7702Content": "Currently only supports revoking EIP-7702 delegation for private key & seed phrase addresses."
        },
        "ViewMore": {
          "text": "View more"
        }
      ...
      "tableConfig": {
        "byContracts": {
          ...
          "columnTip": {
            "contractTrustValue": "Trust value refers to the total asset value spent by this contract. A low trust value indicates either risk or inactivity for 180 days.",
      ...
      "revokeModal": {
        ...
        "confirmRevokeLedger": "Batch revoke {{count}} approvals in one task list",
        "batchRevoke": "Batch Revoke",
        "revokeOneByOne": "Revoke One by One",
        "revoked": "Revoked:",
        "totalRevoked": "Total:",
        "approvalCount_zero": "{{count}} approval",
        "approvalCount_one": "{{count}} approval",
        "approvalCount_other": "{{count}} approvals",
        "signAndStartRevoke": "Sign and Start Revoke",
        "pause": "Pause",
        "resume": "Continue",
        "done": "Done",
        "ledgerConfirmTitle": "Batch Revoke with Ledger",
        ...
        "gasNotEnough": "Insufficient Gas to submit",
        "gasTooHigh": "Gas fee is high",
        "submitTxFailed": "Fail to Submit",
        "defaultFailed": "Transaction failed",
    ...
    "gasTopUp": {
      ...
      "Confirm": "Confirm",
      "Deposit-tip": "Deposit with USDC/USDT",
      "Value": "Value",
    ...
    "swap": {
      ...
      "no-fee-for-wrap": "No Rabby fee for Wrap",
      "hidden-no-quote-rates_one": "{{count}} rate unavailable",
      "hidden-no-quote-rates_other": "{{count}} rates unavailable",
      ...
      "no-slippage-for-wrap": "No slippage for Wrap",
      "approve-tips": "1.Approve → 2.Swap",
      "best": "Best",
      ...
      "the-following-swap-rates-are-found": "Found following rates",
      ...
      "actual": "Actual:",
      "max": "MAX",
      "two-step-approve": "Sign 2 transactions to change allowance",
      "two-step-approve-details": "Token USDT requires 2 transactions to change allowance.First you would need to reset allowance to zero, and only then set new allowance value.",
      ...
      "lowCreditModal": {
        "title": "This token has a low credit value",
        "desc": "A low credit value often signals high risk, such as a honeypot token or very low liquidity."
      },
      "understandRisks": "I understand the risks and want to continue"
    },
    "bridge": {
      ...
      "bridgeDbkBtn": "Bridge via DBK Official Service"
    },
    "manageAddress": {
    ...
    "dashboard": {
      "home": {
        ...
        "chain": " chain, ",
        "chainEnd": " chain",
        "appChainTips": "Hyperliquid & Polymarket Account not included",
        "slotAppChainTips": "{{appChainNames}} Account not included"
      },
      "recentConnection": {
        ...
        "connectedDapp": "Rabby is not connected to the current Dapp.To connect, find and click the connect button on the Dapp’s webpage.",
        ...
        "metamaskModeTooltipNew": "Rabby Wallet will connect when you select \"MetaMask\" on the Dapp. You can manage this in More > Connect Rabby by Disguising as MetaMask"
      },
      "feedback": {
        "directMessage": {
      ...
      "rabbyBadge": {
        ...
        "freeGasTitle": "Claim Free Gas Badge for",
        "enterClaimCode": "Enter claim code",
        "swapTip": "You need to complete a swap with notable dex within Rabby Wallet first.",
        "freeGasTip": "Please sign a transaction using Free Gas. The 'Free Gas' button will appear automatically when your gas is not enough.",
        "learnMore": "Learn More",
        "goToSwap": "Go to Swap",
        "claim": "Claim",
        "viewYourClaimCode": "View your claim code on DeBank",
        "noCode": "You haven’t activated claim code for this address",
        "freeGasNoCode": "Please click the button below to visit DeBank and get the claim code using your current address first.",
        "learnMoreOnDebank": "Learn more on DeBank",
        "rabbyValuedUserNo": "Rabby Valued User No.{{num}}",
        "rabbyFreeGasUserNo": "Rabby Free Gas User No.{{num}}",
      ...
      "settings": {
        ...
        "clearPending": "Clear Pending Locally",
        "clearPendingTip1": "This action removes the pending transaction from your interface, helping resolve issues caused by long pending durations on the network.",
        "clearPendingTip2": "It does not affect your account balances or require re-entering your seed phrase. All assets and account details remain secure.",
        ...
        "settings": {
          ...
          "metamaskMode": "Connect Rabby by Disguising as MetaMask",
          "enableDappAccount": "Switch Dapp Address Independently"
        },
        "aboutUs": "About us",
        ...
        "clearPendingWarningTip": "The removed transaction may still be confirmed on-chain unless it is replaced.",
        "DappAccount": {
          "title": "Switch Dapp Address Independently",
          "desc": "Once enabled, you can choose which address to connect to each Dapp independently. Switching your main address won't affect the address connected to each Dapp.",
          "button": "Enable"
        },
        "rateModalTriggerOnHome": {
          "description": "How do you rate Rabby Wallet ?"
        },
        "rateModal": {
          "thxDesc": "If you like Rabby, a quick rating on the Chrome Store would mean a lot.",
          "thxTitle": "Thank you!",
          "rateOnChromeStoreButton": "Rate on Chrome Web Store",
          "feedbackDesc": "Have feedback? We’re listening.",
          "submitFeedbackButton": "Submit",
          "feedbackPlaceholder": "Rabby values your feedback!",
          "feedbackSuccess": "Thank you for your feedback!"
        }
      },
      "tokenDetail": {
        "noIssuer": "No issuer information available",
        "NoListedBy": "No listing information available",
        "NoSupportedExchanges": "No supported exchanges available",
        "customizedHasAddedTips": "The token is not listed by Rabby. You've added it to the token list manually.",
        "AddToMyTokenList": "Add to my token list",
        "maybeScamTips": "This is a low-quality token and may be a scam",
        "verifyScamTips": "This is a scam token",
        ...
        "ContractAddress": "Contract Address",
        "myBalance": "My Balance",
        "BridgeIssue": "Bridged token by a third party",
        "OriginIssue": "Natively issued on this blockchain",
        "BridgeProvider": "Bridge Provider",
        "IssuerWebsite": "Issuer’s Website",
        "OriginalToken": "Original Token",
        "ListedBy": "Listed by",
        "SupportedExchanges": "Supported Exchanges",
        "fdvTips": "The market cap if the max supply was in circulation.Fully Diluted Valuation (FDV) = Price x Max Supply. If Max Supply is null, FDV = Price x Total Supply. If neither Max Supply nor Total Supply is defined or infinite, FDV is not displayed.",
        "blockedTips": "Blocked token will not be shown in token list",
        "customizedButton": "customized",
        "customizedButtons": "customized",
        "customizedListTitle": "custom token",
        "customizedListTitles": "custom tokens",
        "blockedListTitle": "blocked token",
        "blockedListTitles": "blocked tokens",
        "blockedButton": "blocked",
        "blockedButtons": "blocked",
        "bridgeToEth": "Bridge to Ethereum Chain",
        "bridge": "Bridge"
      },
      "assets": {
        "usdValue": "USD VALUE",
        ...
        "tokenButton": {
          "subTitle": "Tokens on this list will not be added to the total balance."
        },
        "table": {
        ...
        "AddMainnetToken": {
          ...
          "isBuiltInToken": "Token already supported"
        },
        "AddTestnetToken": {
      ...
      "hd": {
        ...
        "ledger": {
          ...
          "reconnect": "If it doesn't work, try <1>reconnecting from the beginning.</1>",
          "connected": "Ledger connected"
        },
        "keystone": {
          "title": "Ensure your Keystone 3 Pro is on the homepage",
        ...
        "ledgerIsDisconnected": "Your ledger is not connected",
        "onekeyIsDisconnected": "Your OneKey is not connected",
        "trezor": {
          "doc1": "Plug in your Trezor device",
          "doc2": "Unlock your device"
        },
        "onekey": {
          "doc1": "Install <1>OneKey Bridge<1/>",
          "doc2": "Plug in your OneKey device",
          "doc3": "Unlock your device"
        }
      },
      "GnosisWrongChainAlertBar": {
        "notDeployed": "Your Safe address is not deployed on this chain"
      },
      "echologyPopup": {
        "title": "Ecosystem"
      },
      ...
      "offlineChain": {
        "chain": "{{chain}} will soon not be integrated.",
        "tips": "{{chain}} Chain will not be integrated on {{date}}. Your assets won’t be affected but won’t be included in your total balance. To access them, you may add it as a custom network in “More”."
      },
      "recentConnectionGuide": {
        "title": "Switch address for Dapp connection here",
        "button": "Got it"
      },
      "rabbyPointsPopup": {
        "title": "Rabby Points",
        "desc": "Check your points in Rabby Mobile.",
        "downloadIntro": "Don’t have the app yet? Download now."
      }
    },
    "nft": {
      "floorPrice": "/ Floor Price:",
    ...
    "newAddress": {
      ...
      "seedPhrase": {
        ...
        "importQuestion1": "If I lose or share my seed phrase, I’ll lose access to my assets permanently",
        "importQuestion2": "My seed phrase is only stored on my device. Rabby can’t access it",
        "importQuestion3": "If I uninstall Rabby without backing up my seed phrase, it cannot be recovered by Rabby",
      ...
      "privateKey": {
        ...
        "repeatImportTips": {
          "desc": "This address has been imported.",
          "question": "Do you want to switch to this address?"
        },
        "isItSafeToImportItInRabby": {
          "question": "Is it safe to import it in Rabby?",
          "answer": "Yes, it will be stored locally on your browser and only accessible to you."
      ...
      "keystone": {
        ...
        "keystonePermissionTip": "Please click \"Allow\" below to authorize access to your Keystone in the following pop-up window, and ensure your Keystone 3 Pro is on the homepage.",
      ...
      "onekey": {
        "onekeyPermission1": "Connect to an USB device",
        "allowRabbyPermissionsTitle": "Allow Rabby permissions to:",
        "onekeyPermissionTip": "Please click \"Allow\" below to authorize access to your OneKey in the following pop-up window. If OneKey doesn't appear in the popup, please check if your device is properly connected to the computer.",
        "whyOneKey": "Why OneKey?",
        "buyOneKey": "Buy OneKey",
        "haveOneKey": "Don't have a OneKey yet?"
      },
      "walletConnect": {
      ...
      "hd": {
        ...
        "manageNgraveZero": "Manage NGRAVE ZERO",
        "done": "Done",
    ...
    "addToken": {
      ...
      "hasAdded": "You have been added this token."
    },
    "switchChain": {
    ...
    "securityEngine": {
      ...
      "undo": "Undo",
      "riskProcessed": "Risk alert have been ignored",
      "ignoreAlert": "Ignore the alert",
      "ruleDisabled": "Security rules have been disabled. For your safety, you can turn it on anytime.",
      "unknownResult": "Unknown result because security engine is unavailable right now",
    ...
    "connect": {
      ...
      "SelectWallet": {
        ...
        "desc": "Select from the wallets you have installed"
      },
    ...
    "backupSeedPhrase": {
      ...
      "qrCodePopupTitle": "QR Code",
      "qrCodePopupTips": "Never share the seed phrase QR code to anyone else. Please view it in a secure environment and keep it carefully."
    },
    "backupPrivateKey": {
    ...
    "createPassword": {
      ...
      "agree": "I have read and agree to the<1/> <2>Terms of Use</2> and <4>Privacy Policy</4>"
    },
    "welcome": {
      "step1": {
    ...
    "pendingDetail": {
      ...
      "Predict": {
        ...
        "skipNonce": "Your address has Nonce skipped on Ethereum chain causing current transaction can’t complete"
      }
    },
    "dappSearch": {
      "selectChain": "Select Chain",
      ...
      "searchPlaceholder": "Search Dapp name",
      "searchButton": "Search"
    },
    "rabbyPoints": {
      "title": "Rabby Points",
      ...
      "claimModal": {
        ...
        "activeStats": "Active Status",
        "referral-code": "Referral Code",
        "invalid-code": "invalid code",
        "cantUseOwnCode": "You cannot use your own referral code.",
        "season2": "Season 2"
      },
      "referralCode": {
      ...
      "secondRoundEnded": "🎉 The second round of Rabby Points has ended"
    },
    "customTestnet": {
      ...
      "ConfirmModifyRpcModal": {
        "desc": "The chain is already integrated by Rabby. Do you need to modify its RPC URL?"
      }
    },
    "addChain": {
      "title": "Add Custom Network to Rabby",
    ...
    "ecology": {
      "sonic": {
        "home": {
          "airdrop": "Airdrop",
          "airdropDesc": "~200 million S to users on Opera and Sonic.",
          "airdropBtn": "Earn points",
          "arcadeDesc": "Play free games to earn points for the S airdrop.",
          "arcadeBtn": "Play now",
          "migrateTitle": "Migrate",
          "migrateDesc": "→",
          "migrateBtn": "Coming soon",
          "earnTitle": "Earn",
          "earnDesc": "Stake your $S",
          "earnBtn": "Coming soon",
          "socialsTitle": "Get Involved"
        },
        "points": {
          "sonicPoints": "Sonic Points",
          "referralCode": "Referral code",
          "referralCodeCopied": "Referral code copied",
          "today": "Today",
          "shareOn": "Share on",
          "sonicArcade": "Sonic Arcade",
          "sonicArcadeBtn": "Start playing",
          "pointsDashboard": "Points Dashboard",
          "pointsDashboardBtn": "Start earning points",
          "errorTitle": "Unable to load points",
          "errorDesc": "There was an error loading your points. Please try again.",
          "retry": "Retry",
      ...
      "dbk": {
        "home": {
          "bridge": "Bridge To DBK Chain",
          "bridgePoweredBy": "Powered by OP Superchain",
          "bridgeBtn": "Bridge",
          "mintNFT": "Mint DBK Genesis NFT",
          "mintNFTDesc": "Be a witness of DBK Chain",
          "mintNFTBtn": "Mint"
        },
        "bridge": {
          "tabs": {
          ...
          "info": {
            ...
            "receiveOn": "Receive on {{chainName}}",
          ...
          "ActivityPopup": {
            ...
            "status": {
              "deposit": "Deposit",
              "withdraw": "Withdraw",
              "waitingToProve": "State root published",
              "rootPublished": "State root published",
              "readyToProve": "Ready to prove",
              "proved": "Proved",
          ...
          "WithdrawConfirmPopup": {
            "question1": "I understand it will take ~7 days until my funds are claimable on Ethereum after I prove my withdrawal",
            "question2": "I understand once a withdrawal is initiated it cannot be sped up or cancelled",
            "question3": "I understand network fees are approximate and will change",
            "title": "DBK Chain Withdrawal takes ~7 days",
            "tips": "Withdrawing involves a 3-step process, requiring 1 DBK Chain transaction and 2 Ethereum transactions",
            "step1": "Initiate withdrawal",
            "step2": "Prove on Ethereum",
    ...
    "miniSignFooterBar": {
      ...
      "signWithOneKey": "Sign with OneKey",
      "status": {
        "txCreated": "Transaction created",
        "txSigned": "Signed. Creating transaction",
        "txSending": "Sending signing request",
        "txSendings": "Sending signing request({{current}}/{{total}})"
      },
      "speedUpTitle": "Speed Up",
      "cancelTitle": "On-chain Cancel",
      "cancleDesc": "Gas price increased by {{percent}} to cancel transaction",
      "speedUpDesc": "Gas price increased by {{percent}} to speed up"
    },
    "gasAccount": {
      "title": "GasAccount",
      "gasToken": "Gas Token",
      ...
      "safeAddressDepositTips": "Multisig addresses are not supported for deposits.",
      "risk": "Your current address has been detected as risky, so this feature is unavailable.",
      "logout": "Log out current GasAccount",
      "switchAccount": "Switch GasAccount",
      "withdrawDisabledIAP": "Withdrawals are disabled because your balance includes fiat funds, which cannot be withdrawn. Contact support to withdraw your token balance",
      "history": {
      ...
      "loginInTip": {
        ...
        "loginAndClaim": "Log in and Claim {{usdValue}}",
        "gotIt": "Got it",
        "loginTips1": "Pay gas fees for",
        "loginTips2": "any address on any chain",
        "loginTips3": "when you're out of gas",
        "learnAbout": "Learn more about GasAccount"
      },
      "about": {
        "title1": "What is GasAccount",
        "desc1": "GasAccount is a new way to pay gas fees. Instead of using native tokens on each chain, you can use one account to cover gas for all your addresses on all chains. Simple, optional, and never out of gas.",
        "title2": "How to use Gas Account",
        "desc2": "Add funds to your GasAccount and use it for any transaction. When signing, choose to pay gas with native tokens or GasAccount, switch anytime.",
        "title3": "Does GasAccount have extra fees",
        "desc3": "Rabby Wallet charges no extra fees. You only pay the gas for your transaction and a small amount of gas for sending that gas from GasAccount to your address.",
        "title4": "Is GasAccount safe",
        "desc4": "GasAccount requires no contract approvals or permissions. You deposit to Rabby’s GasAccount address, and Rabby sends gas to your address when needed. Fully secure by design."
      },
      "loginConfirmModal": {
        "title": "Select an address to log in",
        "desc": "Once confirmed, you can only deposit it at this address"
      },
      "gasAccountList": {
        "address": "Address",
        "gasAccountBalance": "Gas Balance"
      },
      "logoutConfirmModal": {
      ...
      "withdrawPopup": {
        ...
        "noEnoughValueBalance": "Vault Balance insufficient. Switch chain or try again later.",
        ...
        "withdrawalTip": "Available withdrawal balance: {{amount}}",
        "noBalance": "No balance",
        "title": "Withdraw",
        ...
        "amountTooLowCoverFee": "Amount too low to cover gas fees"
      },
    ...
    "newUserImport": {
      "guide": {
        ...
        "desc": "Your go-to wallet for Ethereum and EVM",
        "createNewAddress": "Create a new address",
        "importAddress": "I already have an address"
      },
      "createNewAddress": {
        "title": "Before You Start",
        "desc": "Please read and keep the following security tips in mind",
        "tip1": "If I lose or share my seed phrase, I’ll lose access to my assets permanently",
        "tip2": "My seed phrase is only stored on my device. Rabby can’t access it",
        "tip3": "If I uninstall Rabby without backing up my seed phrase, it cannot be recovered by Rabby",
        "showSeedPhrase": "Show Seed Phrase"
      },
      "importList": {
      ...
      "readyToUse": {
        "title": "Your Rabby Wallet is Ready !",
        "desc": "Find Rabby Wallet and Pin it",
        "pin": "Pin Rabby Wallet",
        "extensionTip": "Click <1/> and then <3/>",
        "guides": {
          "step1": "Click the browser extension icon",
          "step2": "Pin Rabby Wallet"
        }
      },
      "importSeedPhrase": {
      ...
      "importOneKey": {
        "qrcode": {
          "desc": "Scan the QR code on the OneKey hardware wallet"
        },
        "title": "Connect your OneKey hardware wallet via USB",
        "tip1": "1. Plug in your OneKey device",
        "tip2": "2. Unlock your device",
        "tip3": "3. Please ensure only one OneKey device is connected",
      ...
      "importBitBox02": {
        "title": "BitBox02",
        "tip1": "1. Install the <1>BitBoxBridge<1/>",
        "tip2": "2. Plug in your BitBox02",
    ...
    "metamaskModeDappsGuide": {
      "title": "Connect Rabby by Disguising as MetaMask",
      "alert": "Can't connect to a Dapp because it doesn't show Rabby Wallet as an option?",
      "step1": "Step 1",
      "step1Desc": "Allow Rabby to disguise as MetaMask on the current Dapp",
      "step2": "Step 2",
      "step2Desc": "Refresh and connect via MetaMask",
      "manage": "Manage Allowed Dapps",
      "noDappFound": "No Dapp found",
      "toast": {
        "enabled": "Disguise enabled. Refresh the Dapp to reconnect.",
        "disabled": "Disguise disabled. Refresh the Dapp."
      }
    },
    "syncToMobile": {
      "title": "Sync Wallet Address from Rabby Extension to Mobile",
      "description": "Your address data stays fully offline, encrypted, and securely           transferred via a QR code.",
      "steps1": "1. Download Rabby Mobile",
      "steps2": "2. Scan with Rabby Mobile",
      "steps2Description": " *Your QR code contains sensitive data. Keep it private and never             share it with anyone.",
      "downloadGooglePlay": "Google Play",
      "downloadAppleStore": "App Store",
      "clickToShowQr": "Click to Select Address  and Show QR Code",
      "selectAddress": {
        "title": "Select Addresses to Sync"
      },
      "disableSelectAddress": "Sync not supported for {{type}} address",
      "disableSelectAddressWithSlip39": "Sync not supported for {{type}} address with slip39",
      "disableSelectAddressWithPassphrase": "Sync not supported for {{type}} address with passphrase",
      "selectedLenAddressesForSync_one": "Selected {{len}} address for sync",
      "selectedLenAddressesForSync_other": "Selected {{len}} addresses for sync",
    ...
    "search": {
      ...
      "header": {
        "placeHolder": "Search",
        "searchPlaceHolder": "Search Token Name / Address"
      },
      "tokenItem": {
        "gasToken": "Gas Token",
        "FDV": "FDV",
        "listBy": "List by {{name}}",
        "Issuedby": "Issued by",
        "verifyDangerTips": "This is a scam token",
        "scamWarningTips": "This is a low-quality token and may be a scam"
      },
      "searchWeb": {
    ...
    "selectToAddress": {
      ...
      "riskAlert": {
        ...
        "riskType": {
          "risks": {
            "noSend": "No transfers to this address in 180 days",
            "dexNoDeposite": "You're sending to a non-deposit exchange address",
            "contractAddress": "You're sending to a contract, funds may be lost",
            "scamAddress": "You're sending to a scam address"
          }
        }
      },
      "tabs": {
      ...
      "positiveTips": {
        ...
        "sentBefore": "Sent recently",
        "yourOwnAddress": "Your own address"
      },
      "typedTitle": {
        "send": "Send To"
      }
  ...
  "component": {
    "externalSwapBrideDappPopup": {
      "noQuotesForChain": "No quotes available for this chain yet",
      "thirdPartyDappToProceed": "Please use a third-party Dapp to proceed",
      "viewDappOptions": "View Dapp Options",
      "selectADapp": "Select a Dapp",
      "noDapp": "No Dapps available",
      "help": "Please contact the official team of this chain for support",
      "chainNotSupported": "Not supported on this chain",
      "noDapps": "No Dapp available on this chain",
      "swapOnDapp": "Swap on Dapp",
      "bridgeOnDapp": "Bridge on Dapp"
    },
    "TokenChart": {
      "price": "Price",
    ...
    "TokenSelector": {
      ...
      "common": "Common",
      "recent": "Recent",
      "chainNotSupport": "This chain is not supported"
    },
    "ModalPreviewNFTItem": {
      "FieldLabel": {
        "Collection": "Collection",
    ...
    "EcologyNavBar": {
      "providedBy": "Provided by {{chainName}}"
    },
    "EcologyNoticeModal": {
      "title": "Notice",
      "desc": "The following services will be provided directly by third party Ecosystem Partner. Rabby Wallet does not assume responsibility for the security of these services.",
      "notRemind": "Don't remind me again"
    },
    "ReserveGasPopup": {
      "title": "Reserve Gas",
      "instant": "Instant",
    ...
    "PageHeader": {
      "selectAccount": "Select Address"
    },
    "ChainItem": {
      "appChain": "On {{chain}} Account"
    },
    "RiskTip": {
      "title": "Risk Detected"
    },
    "DappActions": {
      "__skip_translation": ["withdraw", "claim"],
      "withdraw": "Withdraw",
      "claim": "Claim",
      "queueDescription": "Current withdrawal​ will enter a waiting queue. Once processed, it can be ​withdrawn​ to your wallet."
    },
  ...
  "global": {
    ...
    "appDescription": "Your go-to wallet for Ethereum and EVM",
    "copied": "Copied",
    "confirm": "Confirm",
    "next": "Next",
    "back": "Back",
  ...
  "background": {
    ...
    "keyring": {
      "onekey": {
        "notFoundDevice": "Device not found",
        "deviceInitializeFailed": "Device error, please restart and try again",
        "needUpgradeFirmware": "Firmware must be upgraded to use the device",
        "thisMethodNeedUpgradeFirmware": "This feature requires firmware upgrade, please upgrade firmware in OneKey app",
        "notAllowInBootloaderMode": "Please use in normal mode",
        "deviceCheckPassphraseStateError": "Account does not match the current device unlock address. Please confirm the device and account address are consistent and try again",
        "actionCancel": "Operation cancelled",
        "deviceNeedsWebHIDPermission": "Device not found or needs WebHID permission"
      }
    }
  },
  "constant": {
