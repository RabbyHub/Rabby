...
export type DappSelectItem = {
  ...
  // loadingIcon?: string;
  // errorImage?: string;
  // requiresPolyMarketPermission?: boolean;
  // rulesKey?: string;
...
const PREDICTION: DappSelectItem[] = [
  ...
  // },
  {
    ...
    //   : 'https://probable-markets-je5yv1wah.pancake.run?_vercel_share=qVFX4O2SCvk7zL8DDuWlOs9EsqA1BoV8',
    TVL: '$21M',
