      ...
      <Wrap>
        ...
        <div className="flex flex-1 min-h-0 overflow-x-auto px-[6px] pt-[6px] pb-[44px]">
          <div className="flex flex-1 min-w-[1180px] min-h-0 gap-[6px]">
            ...
            <div
              className="min-w-[340px] flex-shrink-0 min-h-0 rounded-[6px] overflow-hidden bg-rb-neutral-bg-1"
              style={{ flex: '0 0 20%' }}
            >
              <div className="flex h-full min-h-0 flex-col">
                ...
                <div className="mx-[12px] h-[1px] flex-shrink-0 bg-rb-neutral-line" />
                <AccountInfo />
              </div>
            </div>
          </div>
