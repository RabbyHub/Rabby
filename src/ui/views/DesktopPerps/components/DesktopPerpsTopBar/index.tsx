...
export const DesktopPerpsTopBar: React.FC = () => {
  ...
  return (
    <div className="mx-[6px] mt-[6px] h-[48px] flex-shrink-0 rounded-[6px] bg-rb-neutral-bg-1 flex items-center gap-[24px] px-[12px] min-w-0">
      <div className="flex flex-1 min-w-0 items-center gap-[12px] overflow-hidden">
        <RcIconTopBarLogo className="w-[24px] h-[24px] flex-shrink-0" />

        <div className="h-[12px] w-0 border-l border-solid border-rb-neutral-line flex-shrink-0" />
        ...
        {isEmpty ? (
          ...
          <div className="flex flex-1 min-w-0 items-center gap-[8px] overflow-hidden">
            <RcIconStar className="w-[16px] h-[16px] text-rb-orange-default flex-shrink-0" />
            <div
              ...
              {sortedCoins.map((coin) => {
                ...
                return (
                  <button
                    type="button"
                    key={coin}
                    className="group flex flex-shrink-0 items-center gap-[6px] border-0 bg-transparent p-0 text-[12px] leading-[14px] cursor-pointer"
            ...
            {canScrollRight ? (
              <button
                ...
                className="flex h-[20px] w-[20px] flex-shrink-0 items-center justify-center border-0 bg-transparent p-0 text-rb-neutral-secondary hover:text-rb-neutral-title-1 cursor-pointer"
      ...
      <div className="desktop-perps-topbar-actions flex flex-shrink-0 items-center gap-[12px]">
