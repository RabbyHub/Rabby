          ...
          <Flex direction={'column'} my={'5'}>
            <Card size={'3'}>
              <Flex align={'center'} justify={'center'}>
                <Avatar size={'2'} src={IconMetamask} fallback="" />

                <Text>{t('page.newAddress.metamask.how')}</Text>
              </Flex>
              <Flex mt={'6'}>
                <Card size={'2'}>
                  <Text>{t('page.newAddress.metamask.tips')}</Text>
                  <Text>{t('page.newAddress.metamask.tipsDesc')}</Text>
                </Card>
              </Flex>
            </Card>
          </Flex>
