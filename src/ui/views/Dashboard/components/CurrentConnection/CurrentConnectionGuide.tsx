...
export const CurrentConnectionGuide = memo(
  ({ children, onClose, tips }: Props) => {
    ...
    return (
      <>
        ...
        {ReactDOM.createPortal(
          <div
            className={clsx(
              'fixed w-full h-full left-0 right-0 top-0 bottom-0'
            )}
          >
            <div
            ...
            >
              ...
              <div className="text-r-neutral-title-1 text-[12px] leading-[17px] font-medium">
                {tips ? tips : t('page.dashboard.recentConnectionGuide.title')}
              </div>
              <Button
