...
import { Contacts, RecentConnections } from '../Dashboard/components';
import { Drawer } from 'vaul';
import SwitchThemeModal from 'ui/views/Dashboard/components/Settings/components/SwitchThemeModal';
import { SettingsCardTemplate } from 'ui/component/CardContainer';
...
const OpenApiModal = ({
  ...
  return (
    ...
    >
      <PageRabbyHeader forceShowBack onBack={handleCancel}>
        {title}
      </PageRabbyHeader>
      ...
      items: [
        {
          ...
          rightIcon: (
            <Switch
              ...
              onCheckedChange={handleSwitchWhitelistEnable}
              color={'grass'}
            />
          ),
        },
        ...
        },
        {
          ...
          rightIcon: (
            <>
              ...
              >
                {ThemeModes.find(
                  (item) => item.code.toString() === themeMode.toString()
                )?.name || '-'}
              </span>
              <ThemeIcon
                src={RcIconArrowRight}
        ...
        <div className="popup-settings">
          <div className="content">
            ...
            {Object.values(renderData).map((group, idxl1) => {
              return (
                <>
                  <Card key={`g-${idxl1}`} className={'p-4'} variant={'ghost'}>
                      ...
                      {group.items.map((data, idxl2) => (
                        ...
                        >
                          <Flex align={'center'} gap={'2'}>
                            {data.rightIcon || <LucideChevronRight size={14} />}
                          </Flex>
                        </SettingsCardTemplate>
                      ))}
                    </Flex>
