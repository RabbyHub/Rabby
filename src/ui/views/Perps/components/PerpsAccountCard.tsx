...
export const PerpsAccountCard: React.FC<PerpsAccountCardProps> = ({
  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between">
          ...
          {hasNoBalance ? (
            ...
            <div className="flex items-center gap-12">
              <div
                className={clsx(
                  'w-[44px] h-[40px] rounded-[8px] flex items-center justify-center',
                  'bg-r-blue-light1 hover:border-rabby-blue-default',
                  'text-r-blue-default',
                  'border-[1px] border-solid border-transparent cursor-pointer'
                )}
      ...
      {showNewUserGuide && (
        <div className="bg-r-neutral-card1 rounded-[8px] px-16 py-18 mt-12 relative overflow-hidden">
          <div
            className="absolute top-8 right-8 w-[16px] h-[16px] flex items-center justify-center cursor-pointer text-r-neutral-foot z-10"
            onClick={() => {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div
                className="text-13 text-r-blue-default cursor-pointer flex items-center font-medium"
                onClick={onLearnMore}
              >
