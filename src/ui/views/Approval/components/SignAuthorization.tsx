...
const SignAuthorization = ({
  ...
  const chainInfo = useMemo(() => {
    ...
    if (authRequest.chainId) {
      ...
      return chain
        ...
        : { name: `Chain ${authRequest.chainId}`, id: authRequest.chainId };
    }
    return null;
  }, [authRequest.chainId]);
  ...
  const report = async (
    action:
      | 'createSignAuthorization'
      | 'startSignAuthorization'
      | 'cancelSignAuthorization',
          ...
          <div className="p-[20px]">
            ...
            <div className="bg-[#ec5151] text-white rounded-[8px] p-[16px] mb-[20px]">
              ...
              <div className="text-[14px] opacity-90">
                Signing this authorization gives the target contract full
                control over your account. Only proceed if you trust the
                contract completely.
              </div>
            </div>
            ...
            <div className="mb-[16px]">
              ...
              >
                ...
                >
                  {authRequest.chainId === 0 ? (
                    <>
                      ALL CHAINS - This authorization will work on every EVM
                      chain!
                    </>
                  ) : (
            ...
            <div className="bg-r-neutral-card2 rounded-[8px] p-[12px] mt-[20px]">
              ...
              <ul className="text-[12px] text-r-neutral-body list-disc pl-[16px] space-y-[4px]">
                <li>
                  The contract can execute any transaction as your account
                </li>
                <li>The contract can transfer your tokens and NFTs</li>
                <li>
                  This can be revoked later, but damage may already be done
                </li>
                <li>
                  Only sign if you fully understand and trust the contract
                </li>
              </ul>
            </div>
          </div>
