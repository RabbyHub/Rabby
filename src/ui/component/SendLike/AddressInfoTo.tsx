                ...
                {toAccount?.address ? (
                  ...
                  >
                    <div className="flex flex-col justify-center items-start">
                      {aliasName ? (
                        <span className="text-[16px] mb-[4px] font-semibold leading-[20px] text-r-neutral-title-1">
                          {aliasName}
                        </span>
                      ) : (
                        <MarkedHeadTailAddress
                          ...
                          tailCount={4}
                          address={toAccount?.address || ''}
                          className="text-[16px] mb-[4px] font-semibold leading-[20px] text-r-neutral-title-1"
                        />
                      )}
                      <AddressViewer
