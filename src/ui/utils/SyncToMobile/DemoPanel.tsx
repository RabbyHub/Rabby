...
export const DemoPanel: React.FC = () => {
  return (
    <div className="relative">
      <PhoneSVG className="absolute left-[-75px] top-[-36px]" />
      <div
        className="h-[608px] w-[284px] rounded-[40px] mt-[8px] overflow-hidden bg-r-neutral-bg1"
        style={{
          boxShadow:
      ...
      >
        <video
          ...
          muted
          playsInline
          src="https://static-assets.debank.com/files/ddf5ba9b-8df9-4426-9619-6bb7848d5167.mp4"
        />
      </div>
    </div>
  );
