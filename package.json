{
  ...
  "scripts": {
    ...
    "build:dev:turbo": "cross-env NODE_OPTIONS='--max-old-space-size=16384' TAILWIND_MODE=watch npm run clean && npm run make-theme && webpack --progress --env config=dev",
  ...
  "dependencies": {
    ...
    "@rabby-wallet/rabby-swap": "0.0.68",
